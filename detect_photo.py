...
image_list=glob.glob("input_images/*.jpg")
print(image_list)
...
for i in image_list:
    ...
    frame = cv2.imread(i,0)

    print("Shape of the loaded image is",frame.shape)
...
#     # Hit 'q' on the keyboard to quit!
    if cv2.waitKey(0) & 0xFF == ord('q'):
        break
    cv2.imwrite(f"output_images/{output_filename}", frame)
